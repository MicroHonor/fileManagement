	...
	columns : [
        ...
        {text: '状态', width: 120,dataIndex: 'status',renderer:function(v){
			...
			if(v==-1){
				...
				status =  "<div><img src='js/uploadPanel/icons/ok.png'/></div>";
			}else if(v==-5){
				status =  "停止上传";
			}		
			return status;
		}},
        {
            ...
            width:50,
            items: [{
                icon: 'js/uploadPanel/icons/delete.gif',
                tooltip: 'Remove',
...
//		,{text: '查看', width: 50,dataIndex: 'view'}
	...
	upload_start_handler : function(file){
		...
		var params = me.post_params;
		this.addPostParam("newFileName",encodeURIComponent(rec.get('fileName')));
		this.addPostParam("id",params.id);
		this.addPostParam("uuid",params.uuid);
	},
